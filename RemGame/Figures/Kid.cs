...
/// </summary>
        ...
        public void bend()
        {
            ...
            torso.Position = new Vector2(wheel.Position.X,wheel.Position.Y-48);
...
/*
            if(prevKeyboardState.IsKeyDown(Keys.Down) && keyboardState.IsKeyUp(Keys.Down))
            {
                torso.Position = new Vector2(torso.Position.X,torso.Position.Y+48);
            }
       */     
